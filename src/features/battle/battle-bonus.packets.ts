...
export class SpawnBonusPacket extends BasePacket {
    static readonly schema = defs.battle.SpawnBonus.schema!;
    id: string | null = null;
    ...
    static getId(): number { return defs.battle.SpawnBonus.id; }
}
...
export class RemoveBonusPacket extends BasePacket {
    static readonly schema = defs.battle.RemoveBonus.schema!;
    id: string | null = null;
    ...
    static getId(): number { return defs.battle.RemoveBonus.id; }
}
...
export class TakeBonusPacket extends BasePacket {
    static readonly schema = defs.battle.TakeBonus.schema!;
    id: string | null = null;
    constructor(id: string | null = null) { super(); this.id = id; }
    ...
    static getId(): number { return defs.battle.TakeBonus.id; }
}
...
export class GoldBoxTakenNotificationPacket extends BasePacket {
    static readonly schema = defs.battle.GoldBoxTakenNotification.schema!;
    ...
    static getId(): number { return defs.battle.GoldBoxTakenNotification.id; }
}
...
export class GoldBoxComingNotificationPacket extends BasePacket {
    static readonly schema = defs.battle.GoldBoxComingNotification.schema!;
    ...
    static getId(): number { return defs.battle.GoldBoxComingNotification.id; }
}
...
export class TakeBonusCommandPacket extends BasePacket {
    static readonly schema = defs.battle.TakeBonusCommand.schema!;
    id: string | null = null;
    ...
    static getId(): number { return defs.battle.TakeBonusCommand.id; }
}
